<footer>
        ...
        <div class="contact-wrap grid">
            <div class="contact-info col-12 col-6-md">
                <p>Reach out if you want to collaborate, share knowledge, provide feedback or just say hi.</p>
                <ul>
            ...
            <div class="contact-form col-12 col-6-md">
                <p>Meet me for a cup of tea!</p>
                <div class="graphic"> 
                    <img src="./assets/img/ssupix.png" alt="ssupix graphic">
                </div>
            </div>
        </div>
        <div class="footer-bottom" id="footer">
            <h4>@whossupix 2024</h4>
